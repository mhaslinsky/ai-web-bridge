...
- `tell_canvas_chat` always operates on a freshly-duplicated canvas; original is never modified. Verb sanity layer is a coarse filter, not a security mitigation.
